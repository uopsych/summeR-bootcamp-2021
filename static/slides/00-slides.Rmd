...
###  Welcome to the 4th annual UO Psych R Bootcamp!
...
<br><br><br><br><br><br><br><br><br><br><br><br><br>
```{r echo = FALSE, out.width="75%"}
knitr::include_graphics("images/vinita.png")
```
...
#### `r icon::fa("calendar")`  **Day 1: Wednesday, 9/22, 9 AM - 12 PM PST**
+ Basics of R & RStudio
...
#### `r icon::fa("calendar")`  **Day 2: Thursday, 9/23, 9 AM - 1 PM PST**
...
#### `r icon::fa("calendar")`  **Day 3: Friday, 9/24, 9 AM - 1 PM PST**
...
.column[.content[.center[
<br><br><br><br><br>
# [`r fontawesome::fa("r-project", height = "120px")`](https://rstudio.cloud/spaces/169455/join?access_code=yWOd%2Fuf8lAnvG%2Bz1KkK38lol4iUfCMrw60kxkTq2)
...
### Slack <br> **#bootcamp2021**
]]]

.column[.content[.center[
<br><br><br><br><br>
# [`r fontawesome::fa("github", height = "120px")`](https://github.com/uopsych/summeR-bootcamp-2021)
...
+ You can use R for more than data analysis, including:
  ...
  + entire APA-formatted manuscripts
--
...
### `r emo::ji("link")` [uopsych-r-bootcamp-2021.netlify.app](https://uopsych-r-bootcamp-2021.netlify.app/)
